// Global variables
        ...
        document.getElementById('disasterForm').addEventListener('submit', function(e) {
            ...
            const refId = 'DRRM-DIS-' + Date.now().toString().slice(-6) + Math.random().toString(36).substring(2, 5).toUpperCase();
            ...
            setTimeout(() => {
                ...
                console.log('Disaster Report Data:', Object.fromEntries(new FormData(this)));
            }, 1500);
        });
